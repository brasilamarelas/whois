...
namespace ElasticBase\Libraries\PSR0;
...
class SplClassLoader
{
    ...
    public function loadClass($className){
        try{
            $className = ltrim(implode('/',explode('\\',$className)), '\\');
            $fileName = '';
            $namespace = '';
            ...
            $require_filename = ($this->getIncludePath() !== null ? $this->getIncludePath() . DIRECTORY_SEPARATOR : '') . $fileName;
